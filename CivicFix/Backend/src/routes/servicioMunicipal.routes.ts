...
servicioRouter.post("/api/servicios", cors(), verificarAdministrador, (req,res) => {
    const controller = new ServicioMunicipalController();
    controller.crearServicio(req,res);
});

servicioRouter.put("/api/servicios/:id", cors(), verificarAdministrador, (req,res) => {
    const controller = new ServicioMunicipalController();
    controller.actualizarServicio(req,res);
});

servicioRouter.delete("/api/servicios/:id", cors(), verificarAdministrador, (req,res) => {
    const controller = new ServicioMunicipalController();
